...
export default function authentication(state = initialState, action) {
  switch (action.type) {
    ...
    case userConstants.LOGIN_SUCCESS: // => Tengo este tipo cuando el login es satisfactorio
      return {
        loggedIn: true,
        user: action.user
      };
    case userConstants.LOGIN_FAILURE: // => Tengo este tipo cuando el login fallo retorna el state vacio
      return {};
    case userConstants.LOGOUT: // => Tengo este tipo cuando se cierra la session retorna el state vacio
      return {};
    default:
      return state;
  }
