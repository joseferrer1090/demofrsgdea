    ...
    return (
      <Fragment>
        <Modal className="modal-lg" isOpen={this.state.modal}>
          <ModalHeader>{t("app_cargo_modal_export_titulo")}</ModalHeader>
          <ModalBody>
            <table className="table table-responsive table-bordered  table-hover table-striped fixed_header">
              <thead className="">
                <tr>
                  <th>{t("app_cargo_modal_export_table_codigo")}</th>
                  <th>{t("app_cargo_modal_export_table_nombre")}</th>
                  <th>{t("app_cargo_modal_export_table_descripcion")}</th>
                  <th>{t("app_cargo_modal_export_table_estado")}</th>
                </tr>
              </thead>
              <tbody className="">
                {data.map((aux, id) => {
          ...
          <ModalFooter>
            ...
            >
              ...
              {t("app_cargo_modal_export_table_button_cerrar")}{" "}
            </button>

            <CSVLink data={csv} className="btn btn-secondary btn-sm">
              <i className="fa fa-download" />{" "}
              {t("app_cargo_modal_export_table_button_exportar")}
            </CSVLink>
          </ModalFooter>
        </Modal>
      </Fragment>
