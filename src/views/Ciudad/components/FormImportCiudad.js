...
import UploadFormCiudad from "./Forms/UploadFormCiudad";
...
const FormImportCiudad = props => {
  return (
    <div className="animated fadeIn">
      <UploadFormCiudad importarmasivo={data} />
      <br />
    </div>
  );
};

export default FormImportCiudad;

// import React, { Component } from "react";
// import { Row, Col } from "reactstrap";
// import { CsvToHtmlTable } from "react-csv-to-table";

// class FormImportCiudad extends Component {
//   constructor(props) {
//     super(props);
//     this.state = {
//       file: [],
