...
export default withFormik({
  mapPropsToValues: props => ({
    separador: props.dependencias.sepadador,
    cabeza_titulos: props.dependencias.cabeza_titulos
  }),
  validationSchema: Yup.object().shape({
    separador: Yup.string()
      .required('es necesario agregar el separador')
