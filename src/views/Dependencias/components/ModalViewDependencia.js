                  ...
                  <div className="row">
                    <div className="col-md-6">
                      <div className="form-group">
                        <dl className="param">
                          <dt>
                            {t("app_dependencia_modal_ver_conglomerado")}{" "}
                          </dt>
                          <dd>
                            {
                              this.state
                        ...
                        <div className="row">
                          <div className="col-md-6">
                            <div className="form-group">
                              <dl className="param">
                                ...
                                <dd>
                                  {" "}
                                  {this.state.dataDependenceCharge.name}{" "}
                                </dd>
                              </dl>
                            </div>
                          </div>
                          <div className="col-md-6">
                            <div className="form-group">
                              <dl className="param">
                                <dt>
                                  {t("app_dependencia_modal_ver_estado")}{" "}
                                </dt>
                                <dd>
                                  {statusDependence(
