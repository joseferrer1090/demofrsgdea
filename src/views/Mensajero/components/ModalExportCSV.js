            ...
            <table className="table table-responsive  table-hover table-striped fixed_header">
              <thead className="">
                <tr>
                  <th>
                    {this.props.t(
                      'app_mensajero_modal_export_table_identificacion'
                    )}
                  </th>
                  <th>
                    {this.props.t('app_mensajero_modal_export_table_nombre')}
                  </th>
                  <th>
                    {this.props.t(
                      'app_mensajero_modal_export_table_descripcion'
                    )}
                  </th>
                  <th>
                    {this.props.t('app_mensajero_modal_export_table_estado')}
                  </th>
                </tr>
              </thead>
              <tbody className="">
