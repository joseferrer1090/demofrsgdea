...
import fileCountry from "./../../../assets/files/FilesImportCSV/country.csv";
import { decode } from "jsonwebtoken";
import { COUNTRIES_IMPORT } from "./../../../services/EndPoints";

class FormImportPais extends React.Component {
  state = {
    file: null,
            ...
            <div className="list-group">
              <a className="list-group-item list-group-item-action flex-column align-items-start">
                <div className="d-flex w-100 justify-content-between">
                  <h5 className="mb-1">{t("app_pais_import_step_1")}</h5>
                </div>
              ...
              <a className="list-group-item list-group-item-action flex-column align-items-start">
                <div className="d-flex w-100 justify-content-between">
                  <h5 className="mb-1"> {t("app_pais_import_step_2")} </h5>
                </div>
                <p className="mb-1" style={{ textAlign: "justify" }}>
                  {t("app_pais_import_step_2_descripcion")}
                </p>
              </a>
              <a className="list-group-item list-group-item-action flex-column align-items-start">
                <div className="d-flex w-100 justify-content-between">
                  <h5 className="mb-1">{t("app_pais_import_step_3")}</h5>
                </div>
                <p className="mb-1" style={{ textAlign: "justify" }}>
                  {t("app_pais_import_step_3_descripcion")}
                </p>
              </a>
            </div>
          </Col>
            ...
            <Formik
              onSubmit={(values, { setSubmitting }) => {
                ...
                setTimeout(() => {
                  ...
                  axios
                    .post(
                      `${COUNTRIES_IMPORT}import?username=${username.user_name}`,
                      formData,
                      {
                        headers: {
                    ...
                    .then(response => {
                      if (response.status === 200) {
                        toast.success(
                          "La importación del país se hizo satisfactoriamente.",
                          {
