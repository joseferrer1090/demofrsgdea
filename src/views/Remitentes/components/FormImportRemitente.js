...
import UploadFormRemitente from "./Forms/UploadFormRemitentes";
...
const FormImportRemitente = props => {
  return (
    <div className="animated fadeIn">
      <UploadFormRemitente importarmasivo={data} />
      <br />
    </div>
  );
};

export default FormImportRemitente;

// import React, { Component } from "react";
// import { Row, Col } from "reactstrap";
// import { CsvToHtmlTable } from "react-csv-to-table";
// class FormImportRemitente extends Component {
//   constructor(props) {
//     super(props);
//     this.state = {
//       file: [],
