...
import UploadFormRoles from "./Forms/UploadFormRoles";
...
const FormUploadRoles = props => {
  return (
    <div className="animated fadeIn">
      <UploadFormRoles importarmasivo={data} />
      <br />
    </div>
  );
};

export default FormUploadRoles;
// import React, { Component } from "react";
// import { Row, Col } from "reactstrap";
// import { CsvToHtmlTable } from "react-csv-to-table";

// class FormUploadRoles extends Component {
//   constructor(props) {
//     super(props);
//     this.state = {
//       file: [],
