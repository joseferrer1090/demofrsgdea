            ...
            <div className="list-group">
              <a className="list-group-item list-group-item-action flex-column align-items-start">
                <div className="d-flex w-100 justify-content-between">
                  <h5 className="mb-1">{t('app_sedes_import_step_1')}</h5>
                </div>
              ...
              <a className="list-group-item list-group-item-action flex-column align-items-start">
                <div className="d-flex w-100 justify-content-between">
                  <h5 className="mb-1">{t('app_sedes_import_step_2')}</h5>
                </div>
                <p className="mb-1" style={{ textAlign: 'justify' }}>
                  {t('app_sedes_import_step_2_descripcion')}
                </p>
              </a>
              <a className="list-group-item list-group-item-action flex-column align-items-start">
                <div className="d-flex w-100 justify-content-between">
                  <h5 className="mb-1">{t('app_sedes_import_step_3')}</h5>
                </div>
                <p className="mb-1" style={{ textAlign: 'justify' }}>
                  {t('app_sedes_import_step_3_descripcion')}
                </p>
              </a>
            </div>
          </Col>
                        ...
                        <form className="form">
                          <div className="row">
                            <div className="col-md-6">
                              <div className="form-group">
                                <label>
                                  {' '}
                                  {t('app_sedes_import_form_separador')}{' '}
                            ...
                            <div className="col-md-6">
                              <div className="form-group">
                                <label>
                                  {t('app_sedes_import_form_titulos')}
                                </label>
                                <CustomInput
                                  name={'titulos'}
                                  onChange={handleChange}
                                  ...
                                  label={t(
                                    'app_sedes_import_form_titulos_label'
                                  )}
                                  className={
                                    errors.titulos &&
                                    touched.titulos &&
                          ...
                          <div className="row">
                            <div className="col-md-12">
                              <div className="form-group">
                                <label>
                                  {t('app_sedes_import_form_archivo')}{' '}
                                  <b>CSV</b>{' '}
                                  <span className="text-danger"> * </span>
                                </label>
                                <CustomInput
