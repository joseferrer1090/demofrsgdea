...
import UploadFormDocumentalRadicacion from "./Forms/UploadFormDocumentalRadicacion";
...
const FormUploadSedes = props => {
  return (
    <div className="animated fadeIn">
      <UploadFormDocumentalRadicacion importarmasivo={data} />
      <br />
    </div>
  );
};
