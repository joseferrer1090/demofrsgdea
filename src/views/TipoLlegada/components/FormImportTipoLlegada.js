            ...
            <div className="list-group">
              <a className="list-group-item list-group-item-action flex-column align-items-start">
                <div className="d-flex w-100 justify-content-between">
                  <h5 className="mb-1">{t('app_tipoLlegada_import_step_1')}</h5>
                </div>
              ...
              <a className="list-group-item list-group-item-action flex-column align-items-start">
                <div className="d-flex w-100 justify-content-between">
                  <h5 className="mb-1">{t('app_tipoLlegada_import_step_2')}</h5>
                </div>
                <p className="mb-1" style={{ textAlign: 'justify' }}>
                  {t('app_tipoLlegada_import_step_2_descripcion')}
                </p>
              </a>
              <a className="list-group-item list-group-item-action flex-column align-items-start">
                <div className="d-flex w-100 justify-content-between">
                  <h5 className="mb-1">{t('app_tipoLlegada_import_step_3')}</h5>
                </div>
                <p className="mb-1" style={{ textAlign: 'justify' }}>
                  {t('app_tipoLlegada_import_step_3_descripcion')}
                </p>
              </a>
            </div>
          </Col>
                            ...
                            <div className="col-md-6">
                              <div className="form-group">
                                ...
                                <CustomInput
                                  ...
                                  label={t(
                                    'app_tipoLlegada_import_form_titulos_label'
                                  )}
                                  className={
                                    errors.titulos &&
                                    touched.titulos &&
