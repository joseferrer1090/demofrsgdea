...
import UploadFormUsuarios from "./Forms/UploadFormUsuarios";
...
const FormUploadUser = props => {
  return (
    <div className="animated fadeIn">
      <UploadFormUsuarios importarmasivo={data} />
      <br />
    </div>
  );
};
...
// class FormUploadUser extends Component {
//   constructor(props) {
//     super(props);
//     this.state = {
//       file: [],
